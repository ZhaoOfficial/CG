...
int main() {
    ...
    //! world
    RayTracing::hittable_list world = random_scene();
    ...
    RayTracing::camera scene_camera(lookfrom, lookat, vup, 20.0f, aperture, dist_to_focus);
    ...
    for (int j = image_height - 1; j >= 0; --j) {
        ...
        for (int i = 0; i < image_width; ++i) {
            ...
            // gamma correction
            image_line[i] = RayTracing::sqrt(pixel_color);
        }
